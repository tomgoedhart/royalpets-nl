...
- **Format:** Markdown (`.md`)
- **Location:** in the same folder as the referenced prd document.
...
- When generating tasks for new edge functions make a task to trigger @create-prd to make a new edge function specific PRD.
